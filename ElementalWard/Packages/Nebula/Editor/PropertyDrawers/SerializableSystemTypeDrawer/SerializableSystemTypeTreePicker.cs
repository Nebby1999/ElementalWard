...
using UnityEditor;
using UnityEngine;
using Nebula.Editor.TreeDrawer;
            ...
            private Type GetRequiredBaseType()
            {
                ...
                if (requiredBaseType == null)
                {
                    ...
                    if (fieldInfo != null)
                    {
                        ...
                        {
                            SerializableSystemType.RequiredBaseTypeAttribute attribute = (SerializableSystemType.RequiredBaseTypeAttribute)requiredBaseTypeAttribute;
                            if (attribute != null)
                            {
                                requiredBaseType = attribute.requiredType;
                            }
