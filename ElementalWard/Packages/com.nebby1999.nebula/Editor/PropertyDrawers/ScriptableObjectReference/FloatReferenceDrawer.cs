...
namespace Nebula.Editor.PropertyDrawers
{
    ...
    public class FloatReferenceDrawer : PropertyDrawer
    {
        ...
        {
            return prop.FindPropertyRelative(nameof(FloatReference.useConstant)).boolValue;
        }

        void SetConstantValue(SerializedProperty prop, bool booleanValue)
        {
            prop.FindPropertyRelative(nameof(FloatReference.useConstant)).boolValue = booleanValue;
