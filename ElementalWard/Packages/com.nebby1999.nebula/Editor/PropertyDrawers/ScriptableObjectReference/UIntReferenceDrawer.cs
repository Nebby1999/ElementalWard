...
namespace Nebula.Editor.PropertyDrawers
{
    ...
    public class UIntReferenceDrawer : PropertyDrawer
    {
        ...
        {
            return prop.FindPropertyRelative(nameof(UIntReference.useConstant)).boolValue;
        }

        void SetConstantValue(SerializedProperty prop, bool booleanValue)
        {
            prop.FindPropertyRelative(nameof(UIntReference.useConstant)).boolValue = booleanValue;
